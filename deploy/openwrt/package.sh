...
# RELEASE_REPO sets the GitHub owner/repository used by package recovery.
#
# Example:
...
sed -i "s|gnacho/netgrip|${RELEASE_REPO:-gnacho/netgrip}|" "$PKG_DIR/usr/libexec/netgrip-heal-register"
