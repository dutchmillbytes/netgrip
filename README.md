...
such as `linux-armv7` or `linux-mipsle`, to build only those binaries. Forks
can set `RELEASE_REPO=owner/repository` so self-updates follow their releases;
the GitHub workflow supplies this automatically.
